...
var PipelineMaker = function (props) {
    var isMixedData = props.isMixedData, mixedData = props.mixedData, filterMixedDataFunc = props.filterMixedDataFunc;
    var options;
    if (isMixedData) {
        var result = filterMixedDataFunc(mixedData);
        options = result;
    }
    else {
        ...
        react_1.default.createElement(react_1.default.Fragment, null,
            !!indexes.length && indexes.map(function (index, i) {
                return (react_1.default.createElement(StepContainer_1.default, { index: index, key: "step-".concat(index), onClick: deleteStep },
                    react_1.default.createElement(StepSelect_1.default, { items: options, onChange: handleSelectChange, val: props.selectedValues[i], index: index })));
            }),
