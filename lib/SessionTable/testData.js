...
var sortSessions = function (sort, sessions) {
    ...
    if ((_sessions === null || _sessions === void 0 ? void 0 : _sessions.length) > 0) {
        if (sort.field === 'device_id') {
            if (sort.mode === 'asc') {
                _sessions = _sessions.sort(function (a, b) { var _a, _b, _c; return (_c = (_a = a.device_id) === null || _a === void 0 ? void 0 : _a.localeCompare((_b = b.device_id) !== null && _b !== void 0 ? _b : '')) !== null && _c !== void 0 ? _c : 0; });
            }
            else {
                _sessions = _sessions.sort(function (b, a) { var _a, _b, _c; return (_c = (_a = a.device_id) === null || _a === void 0 ? void 0 : _a.localeCompare((_b = b.device_id) !== null && _b !== void 0 ? _b : '')) !== null && _c !== void 0 ? _c : 0; });
            }
        }
        else {
            if (sort.mode === 'asc') {
