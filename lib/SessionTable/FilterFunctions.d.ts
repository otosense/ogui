...
export declare const MultilineOperatorFilter: (label: string, linesValue: Optional<string[]>, onChangeLines: (lines: string[]) => void, operatorValue: Optional<Operator>, onChangeOperator: (op: Operator | null) => void, operatorOptions: Operator[]) => JSX.Element;
