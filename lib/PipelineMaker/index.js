...
var theme2022_1 = __importDefault(require("../shared/theme2022"));
...
var AddOptionInput_1 = __importDefault(require("./AddOptionInput"));
var saveBtnContainer = {
    display: 'flex',
...
var PipelineMaker = function (props) {
    var _a = (0, react_1.useState)([]), innerOptions = _a[0], setInnerOptions = _a[1];
    var _b = (0, react_1.useState)([1]), indexes = _b[0], setIndexes = _b[1];
    (0, react_1.useEffect)(function () {
        var isMixedData = props.options.find(function (option) { return typeof option !== 'string'; });
        if (!!isMixedData) {
            var res = props.options.map(function (item) { return item.toString(); });
            setInnerOptions(res);
        }
        else {
    ...
    var addOption = function (str) {
        setInnerOptions(function (oldArray) { return __spreadArray(__spreadArray([], oldArray, true), [str], false); });
    };
    return (react_1.default.createElement(styles_1.ThemeProvider, { theme: theme2022_1.default },
        react_1.default.createElement(ComponentContainer_1.default, { title: "Create pipeline" },
            react_1.default.createElement(react_1.default.Fragment, null,
                !!indexes.length && indexes.map(function (index, i) {
                    return (react_1.default.createElement(StepContainer_1.default, { index: index, key: "step-".concat(index), onClick: deleteStep },
                        react_1.default.createElement(StepSelect_1.default, { items: innerOptions, onChange: handleSelectChange, val: props.selectedValues[i], index: index })));
                }),
                react_1.default.createElement(AddButton_1.default, { addStep: addStep }),
                react_1.default.createElement(material_1.Box, { sx: saveBtnContainer },
                    react_1.default.createElement(material_1.Button, { onClick: props.handleSave }, "Save")),
                react_1.default.createElement(AddOptionInput_1.default, { addOption: addOption })))));
};
