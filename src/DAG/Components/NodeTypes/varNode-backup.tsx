...
function TextEditorNode(props: ITextEditorNode) {
    ...
    //             console.log('isTargetNode', isTargetNode, node);
    //             console.log('isSourceNode', isSourceNode, node);
    //             // Set the border color based on the conditions
    //             if (isTargetNode && isSourceNode) {
    //                 borderColors[node.id] = 'red'; // Node has a target handle and is not a source node
    //                 node['color'] = 'red';
    //                 setSetColor('red');
    //             } else {
    //                 borderColors[node.id] = 'blue';
    //                 node['color'] = 'blue'; // Default border color
    //                 setSetColor('blue');
    //             }
    //         }
    //         return node;
    ...
    return (
        <div className={`text-updater-node ${type} ${errorMapper(errorMapping, id)}`}>
            ...
            <div className={`flexProps ${type} ${setColor}`}>
