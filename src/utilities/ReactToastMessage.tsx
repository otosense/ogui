...
import { ToastContainer, toast, type ToastContent, Zoom } from 'react-toastify'
...
export function showToast (message: ToastContent = '', type: keyof ToastMethods = 'success', customId = 1): void {
