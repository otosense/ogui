...
const getWfData = () => {
  ...
  let channelData = wfJsonObject.data[0]
    ...
    if(channelData){
      const timeDifferBetweenSamples = Math.floor((1/(channelData?.sr / (1000 * 1000))));
      ...
      let chartData = {"xAxisCategories":sampleTimeArray, "seriesData": data }
